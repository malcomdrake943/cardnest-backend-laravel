            ...
            foreach ($legacySubs as $sub) {
                ...
                DB::table('subscriptions')->updateOrInsert(
                    ...
                    [
                        ...
                        'api_call_limit' => $sub->api_call_limit ?? $sub->api_calls_limit ?? null,
                        'api_calls_used' => $sub->api_calls_used ?? $sub->api_call_used ?? null,
                        'overage_calls' => $sub->overage_calls ?? $sub->overage_call ?? null,
